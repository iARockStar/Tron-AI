...
class AI(RealtimeAI):
    ...
    def initialize(self):
        ...
        self.our_node = minmax.Node(None, None, my_color, self.world, my_color)
        self.our_tree = minmax.Tree(self.our_node)
        self.minmax_object = minmax.MiniMax(self.our_tree)
